...
import { deleteClass } from "@/app/(home)/batches/actions";

interface DeleteClassAlertProps extends React.HTMLAttributes<HTMLDivElement> {
  classId: string;
  children: ReactNode;
  onSuccess?: () => void;
}

export function DeleteClassAlert({
  classId,
  children,
  onSuccess,
